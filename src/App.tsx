...
const TrustLinkLanding = () => {
  ...
  const t = {
    en: {
      ...
      seller_b3_d: "TrustLink verifies every seller before activation — building buyer trust in your products.",
      ...
      buyer_b2_d: "Every seller is physically verified by our Lagos agents before they can list products.",
      buyer_b3_t: "Full delivery to Benin",
      buyer_b3_d: "From Lagos markets to your door in Cotonou or Porto-Novo — we manage the whole route.",
      how_title: "How it works",
      how_sub: "A simple, transparent process from order to delivery.",
      steps_seller: [
        { t: "Register & Verify", d: "Sign up and get verified by our Lagos agents." },
        { t: "Receive Orders", d: "Get bulk purchase requests from Beninese buyers." },
        { t: "Product Verification", d: "Our agents document your products before shipping." },
        { t: "Get Paid", d: "Payment released once buyer confirms satisfaction." },
      ],
      steps_buyer: [
        { t: "Browse & Order", d: "Find products and place your order on the platform." },
        { t: "Secure Payment", d: "Pay in CFA — funds held safely in escrow." },
      ...
      label_role: "I am a",
      label_cat: "Product Category",
      btn: "JOIN THE WAITLIST",
      success_t: "Application Received!",
      success_d: "A TrustLink agent will contact you on WhatsApp within 24 hours.",
      ...
      phase1_title: "Phase 1 — Vendor Responsibility",
      ...
      phase2_title: "Phase 2 — Evidence Collection (48h)",
    ...
    fr: {
      ...
      seller_b3_d: "TrustLink vérifie chaque vendeur avant activation — pour inspirer confiance à vos acheteurs.",
      ...
      buyer_b2_d: "Chaque vendeur est vérifié physiquement par nos agents à Lagos avant toute transaction.",
      buyer_b3_t: "Livraison complète au Bénin",
      buyer_b3_d: "Des marchés de Lagos jusqu'à votre porte à Cotonou ou Porto-Novo.",
      how_title: "Comment ça marche",
      how_sub: "Un processus simple et transparent, de la commande à la livraison.",
      steps_seller: [
        { t: "Inscription & Vérification", d: "Inscrivez-vous et faites vérifier votre boutique par nos agents." },
        { t: "Réception des Commandes", d: "Recevez des demandes d'achat de distributeurs béninois." },
        { t: "Vérification Produit", d: "Nos agents documentent vos produits avant expédition." },
        { t: "Encaissement", d: "Paiement libéré dès confirmation de satisfaction de l'acheteur." },
      ],
      steps_buyer: [
        { t: "Parcourir & Commander", d: "Trouvez des produits et passez votre commande." },
        { t: "Paiement Sécurisé", d: "Payez en CFA — fonds bloqués en séquestre." },
      ...
      label_role: "Je suis",
      label_cat: "Catégorie de produits",
      btn: "REJOINDRE LA LISTE D'ATTENTE",
      success_t: "Demande Reçue !",
      success_d: "Un agent TrustLink vous contactera sur WhatsApp sous 24h.",
      ...
      phase1_title: "Phase 1 — Responsabilité du Vendeur",
      ...
      phase2_title: "Phase 2 — Collecte des Preuves (48h)",
    ...
    <div className="min-h-screen bg-white text-slate-900 font-sans">
          ...
          <div className="flex flex-col lg:flex-row gap-16 items-center">
            ...
            <div className="lg:w-1/2 w-full" id="join">
              <div className="bg-white p-8 md:p-10 rounded-[2.5rem] shadow-2xl border border-slate-100">
                ...
                <a href={activeTab === 'seller' ? 'https://forms.gle/EGKZFiwXWyXFY7zp9' : 'https://forms.gle/LArcmJxxnC52GAGT6'} target="_blank" rel="noopener noreferrer" className="w-full bg-blue-600 text-white font-black py-4 rounded-2xl shadow-lg shadow-blue-100 hover:bg-blue-700 transition-all flex items-center justify-center gap-3">{activeTab === 'seller' ? <Store size={20} /> : <Users size={20} />}{activeTab === 'seller' ? t.btn_seller : t.btn_buyer}<ArrowRight size={18} /></a>
      ...
      <div className="bg-blue-600 py-5">
        <div className="container mx-auto px-6 flex flex-col md:flex-row items-center justify-center gap-6">
          ...
          <a href="https://wa.me/234" className="bg-white text-blue-700 px-8 py-2 rounded-full text-sm font-black hover:bg-blue-50 transition-colors">WhatsApp</a>
        </div>
      </div>
        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm font-bold">
                <li className="flex items-center gap-3"><Mail size={15} className="text-blue-500" /> contact@trustlink.africa</li>
                <li className="flex items-center gap-3"><Phone size={15} className="text-blue-500" /> +234 800 TRUSTLINK</li>
                <li className="flex items-center gap-3"><MessageSquare size={15} className="text-blue-500" /> WhatsApp Support</li>
                <li className="flex items-start gap-3"><MapPin size={15} className="text-blue-500 shrink-0 mt-0.5" /> Lagos: Ikeja — Cotonou: Ganhi</li>
              </ul>
            </div>
          </div>
